...
<form name="wfwidget_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
	...
	<p><?php _e("Wildfireapp Sponsor ID: " ); ?><input type="text" name="wfwidget_sponsor_id" value="<?php echo $sponsor_id; ?>" size="20"><?php _e(" Tutorial: <a href='http://help.wildfireapp.com/faqs/tutorials/how-to-find-your-sponsor-id' target='_blank'>How to find your Wildfire Sponsor ID</a>?" ); ?></p>
	<hr />	
